  ...
  <div class="container col-6">
      ...
      <div class="row">
          <div class="col-md-12 text-start">
              ...
              <input type="text" :disabled="form === 'excluir' " class="form-control" placeholder="ABC-1234 || AAA1A12"
          ...
          <div class="col-md-12 text-start">
              ...
              <select v-model="veiculo.cor" :disable="form === 'excluir' " class="form-select">
                  <option v-for="item in coresEnum" :value="item"> {{ item }}</option>
              </select>
          </div>
          <div class="col-md-12 text-start">
              <label class="form-label mt-3">Tipo *</label>
              <select v-model="veiculo.tipo" :disable="form === 'excluir' " class="form-select">
