...
<div class="container col-6">
        ...
        <div class="row">
            <div class="col-md-12 text-start">
                ...
                <input type="text" :disabled="form === 'excluir' " class="form-control" v-model="condutor.nome">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3" >Cpf do Condutor *</label>
                <input type="text" :disabled="form === 'excluir' " class="form-control" placeholder="121.121.121-12" v-model="condutor.cpf">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3" >Telefone do Condutor *</label>
                <input type="text" :disabled="form === 'excluir' " class="form-control" placeholder="+12(121)12121-1212" v-model="condutor.telefone">
            </div>
        </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        onClickEditar() {
            condutorClient.editar(this.condutor)
                .then(sucess => {
                    this.condutor = new Condutor()
        ...
        onClickExcluir() {
            condutorClient.deletar(this.condutor)
                .then(sucess => {
                    this.condutor = new Condutor()
